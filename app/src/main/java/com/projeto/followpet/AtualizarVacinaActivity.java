...
public class AtualizarVacinaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitle(R.string.tb_atualizar_vacina);
        ...
        mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivityForResult(new Intent(AtualizarVacinaActivity.this, PetPerfilActivity.class),1);
            }
        });
